...
class AsgSol extends StatefulWidget {
  AsgSol({Key? key}) : super(key: key);
  var snap;

  AsgSol.set(this.snap);

  @override
  State<AsgSol> createState() => _AsgSolState();
}

class _AsgSolState extends State<AsgSol> {
  @override
                  ...
                  return snap.toString() != '[]' &&
                      ...
                      : ElevatedButton(
                          onPressed: () async {
                            ...
                            await uploadFile(uploader, "Assignment 1 Solution",
                                '6', widget.snap['aid'].toString());
                            Navigator.pop(context);
                            setState(() {});
                          },
                  ...
                  return snap.toString() != '[]' &&
                      ...
                      : ElevatedButton(
                          onPressed: () async {
                            ...
                            await uploadFile(uploader, "Assignment 2 Solution",
                                '6', widget.snap['aid'].toString());
                            Navigator.pop(context);
                            setState(() {});
                          },
                  ...
                  return snap.toString() != '[]' &&
                      ...
                      : ElevatedButton(
                          onPressed: () async {
                            ...
                            await uploadFile(uploader, "Assignment 3 Solution",
                                '6', widget.snap['aid'].toString());
                            Navigator.pop(context);
                            setState(() {});
                          },
