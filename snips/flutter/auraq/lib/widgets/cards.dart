...
Widget bookCard(context,String token,int id,String name,var desc,String language,String pages,var user){
  Color colors;
  if(id.isEven){
    colors=Colors.blue;
  }
  ...
  return GestureDetector(
    onTap: (){
      Navigator.push(context, MaterialPageRoute(
          builder: (context) => BookDetail.set(token,user,id,name,desc,language,pages)
      ));
    },
    child: Container(
      margin: EdgeInsets.symmetric(
