...
class _PlaceOrderState extends State<PlaceOrder> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
        child: Column(
          children: [
            detailCard(context,widget.responseBody['id'],widget.responseBody['name'],widget.responseBody['short_description'],widget.responseBody['images'][0]['src'],widget.responseBody['images'][1]['src'],widget.responseBody['price'],widget.responseBody['date_created']),
            Center(
              child: Container(
