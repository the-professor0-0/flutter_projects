...
class _SearchState extends State<Search> {
  ...
  Future<List> search() async{
    String url='https://auraqpublications.com/wp-json/wc/v3/orders?product='+searchController.text+'&per_page=100&page=1&consumer_key=ck_b6861beee9817d3feaedb3865305a0c16960ee69&consumer_secret=cs_e69b60d0a7660132bd0205eb5ab7fd07e85f6f7e';
