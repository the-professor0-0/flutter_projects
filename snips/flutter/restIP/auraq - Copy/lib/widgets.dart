                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 2,),
                              Text(bookName, style: TextStyle(fontSize: 17),),
...
Widget form(context,var price,var qty){
  int p=int.parse(price.toString())*int.parse(qty.toString());
  TextEditingController fname , lname , phone , city,address ;
  return Container(
    decoration: BoxDecoration(
    ...
    child: Column(
      children: [
        ...
        txtFieldDisabled("Total Bill : ${p}", city, TextInputType.name, Icons.attach_money_outlined),
        Container(
...
Widget txtFieldDisabled(txt, controller, type, icon) {
  return Container(
    padding: EdgeInsets.symmetric(vertical: 10,horizontal: 10),
    child: TextFormField(
      controller: controller,
